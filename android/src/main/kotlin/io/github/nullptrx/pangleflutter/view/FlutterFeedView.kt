...
//    val adView = ad.adView
  ...
  private fun bindSmallAdView(parent: ViewGroup, @NonNull ad: TTFeedAd): View {
    ...
    val view = LayoutInflater.from(context).inflate(R.layout.pangle_flutter_listitem_ad_small_pic, parent, false)
    ...
    holder.stopButton = view.find(R.id.btn_listitem_stop)
    holder.removeButton = view.find(R.id.btn_listitem_remove)
  ...
  private fun bindData(convertView: ViewGroup, holder: AdViewHolder, ad: TTFeedAd) {
    ...
    bindDislikeCustom(convertView, holder.dislike, ad)
    ...
    creativeViewList.add(holder.creativeButton)
...
//      val id = id
  ...
  internal open class AdViewHolder {
    ...
    lateinit var creativeButton: Button
  ...
  internal class VideoAdViewHolder : AdViewHolder() {
    lateinit var videoView: FrameLayout
  }

  internal class LargeAdViewHolder : AdViewHolder() {
    lateinit var largeImage: ImageView
  }
  ...
  internal class VerticalAdViewHolder : AdViewHolder() {
    lateinit var verticalImage: ImageView
  }

  internal class GroupAdViewHolder : AdViewHolder() {
    lateinit var groupImage1: ImageView
    lateinit var groupImage2: ImageView
    lateinit var groupImage3: ImageView
  }
